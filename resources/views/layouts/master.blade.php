...
<head>
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-149594529-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-149594529-1');
    </script>
    <meta charset="UTF-8">
        ...
        <div class="flex container mx-auto lg:max-w-screen">
            <h1 class="flex w-full text-xl">
                ...
                <div class="w-full text-center">
                    ...
                    <a href="/" class="no-underline text-black dark:text-blue-100 dark:hover:text-blue-300 font-semibold">
                    ...
                    <div class="sm:block hidden flex justify-center flex-wrap text-xs tracking-tight font-semibold ml-1 align-top inline">
                        <a class="flex-1/2 dark:text-gray-600" href="https://twitter.com/jhnbrn90" rel="me">
                ...
                <div class="flex flex-1 justify-end">
                    <a href="/about" class="no-underline text-black dark:text-blue-100 dark:hover:text-blue-300 font-semibold">
